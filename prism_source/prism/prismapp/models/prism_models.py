...
class Merchant(models.Model):
    ...
    hashtags = models.ManyToManyField("prismapp.Hashtag", blank=True, related_name="merchants")
    categories = models.ManyToManyField("prismapp.Category", blank=True, related_name="merchants")
    keywords = models.ManyToManyField("prismapp.Keyword", blank=True, related_name="merchants")
...
class Service(models.Model):
    name = models.CharField(max_length=255, null=False)
    category = models.ForeignKey(Category, on_delete=models.CASCADE, null=True, related_name="add_product")
    keywords = models.ManyToManyField(Keyword, blank=True, related_name="add_product")
    hashtags = models.ManyToManyField(Hashtag, related_name="add_product", blank=True)
    description = models.TextField(null=True, blank=True)
    description_html = models.TextField(null=True, blank=True)
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL)
    total_bookings = models.IntegerField(default=0, null=True, blank=True)
    merchant = models.ForeignKey(Merchant, on_delete=models.CASCADE, null=True, related_name="add_product")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
